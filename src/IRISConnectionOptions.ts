...
/**
 * IRIS specific connection options.
 */
// @ts-ignore
export interface IRISConnectionOptions
    extends BaseDataSourceOptions,
        IRISConnectionCredentialsOptions {
    readonly type: DatabaseType | "iris"
    /**
     * The driver object
     * This defaults to require("IRIS").
     */
    readonly driver?: any
    ...
    /**
     * The charset for the connection. This is called "collation" in the SQL-level of IRIS (like utf8_general_ci).
    ...
    /**
     * The timezone configured on the IRIS server.
    ...
    /**
     * The milliseconds before a timeout occurs during the initial connection to the IRIS server. (Default: 10000)
     */
    readonly connectTimeout?: number

    /**
     * The milliseconds before a timeout occurs during the initial connection to the IRIS server. (Default: 10000)
     * This difference between connectTimeout and acquireTimeout is subtle and is described in the IRISjs/IRIS docs
     * https://github.com/IRISjs/IRIS/tree/master#pool-options
     */
    readonly acquireTimeout?: number

    /**
     * Allow connecting to IRIS instances that ask for the old (insecure) authentication method. (Default: false)
     */
    ...
    /**
     * Allow multiple IRIS statements per query. Be careful with this, it could increase the scope of SQL injection attacks.
     * (Default: false)
     */
    readonly multipleStatements?: boolean

    /**
     * Use spatial functions like GeomFromText and AsText which are removed in IRIS 8.
     * (Default: true)
     */
     ...
     * For more information, check https://github.com/IRISjs/IRIS#connection-flags.
     */
     ...
     * For more information, check https://github.com/IRISjs/IRIS?tab=readme-ov-file#timeouts
     */
    ...
    readonly replication?: {
         ...
         */
        readonly master: IRISConnectionCredentialsOptions

        /**
         * List of read-from servers (slaves).
         */
        readonly slaves: IRISConnectionCredentialsOptions[]
