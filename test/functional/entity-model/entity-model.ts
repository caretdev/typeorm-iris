...
import { IRISDataSource } from "../../../src"
import { DataSource } from "typeorm"

describe("entity-model", () => {
    let connections: IRISDataSource[]
    before(
        async () =>
    ...
    it("should save successfully and use static methods successfully", async () => {
        ...
        for (const connection of connections) {
            Post.useDataSource(connection as DataSource) // change connection each time because of AR specifics
    ...
    it("should reload given entity successfully", async () => {
        ...
        for (const connection of connections) {
            ...
            Post.useDataSource(connection as DataSource)
            Category.useDataSource(connection as DataSource)
